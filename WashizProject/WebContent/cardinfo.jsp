			...
			<nav id="sidebar" role="navigation" data-step="2"
				...
				<div class="sidebar-collapse menu-scroll">
					<ul id="side-menu" class="nav">
						...
						<li class="active"><a href="Washiz.do?submit=viewcardinfo"><i
					...
					<div id="tab-general">
						<div class="row mbl">
							...
							<div class="col-lg-12">
								...
								<%
									if (request.getAttribute("cardinfodata") != null) {
											int id = 0;
								%>
								<div class="panel panel-grey">
									<div class="panel-heading">Card Info</div>
									<div class="panel-body">
										<table class="table table-hover table-bordered">
											...
											<tbody>
												<c:forEach var="data" items="${cardinfodata}">

													<tr>
														<td><%=++id%></td>
														<td>${data.type}</td>
														<td>${data.holdername}</td>
														<td>${data.number1}-xxxx-xxxx-${data.number4}</td>
														<td>${data.expmonth}/${data.expyear}</td>
								...
								<div class="panel panel-grey"
									...
									<div class="panel-body pan">
										...
										<form action="Washiz.do?submit=addcardinfo" method="post">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group mbn">
															<label class="pts">Card Number</label>
														</div>
													</div>
													<div class="col-md-2">
														<div class="form-group">
