        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
					...
					<li><a href="book-a-ninja.jsp"><i
							class="fa fa-desktop fa-fw">
								<div class="icon-bg bg-pink"></div>
						</i><span class="menu-title">Book A Ninja</span></a></li>
					<li class="active"><a href="Washiz.do?submit=viewaddresses"><i class="fa fa-send-o fa-fw">
            ...
            <div id="page-wrapper">
					...
					%>
                            ...
                            <div class="panel-body">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                   <c:forEach var="data" items="${addressdata}">
				...
				<h3>No Addresses Entered</h3>
				<%
					}
				%>

				<div class="panel panel-green" style="width: 400px;margin-top: 50px">
					<div class="panel-heading">Add More</div>
					<div class="panel-body pan">
						<form action="Washiz.do?submit=addaddress" method="post">
							<div class="form-body pal">
								<div class="form-group">
									<label for="inputSubject" class="control-label"> Name</label>
									<div class="input-icon right">
										<input id="inputSubject" type="text" placeholder=""
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label for="inputName" class="control-label"> Flat/
												House No.</label>
											<div class="input-icon right">
												<input id="inputName" type="text" placeholder=""
													class="form-control" name="hnumber" />
											</div>
										</div>
									</div>
									<div class="col-md-6">
