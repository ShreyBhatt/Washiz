	...
	<div>
		...
		<div id="wrapper">
			...
			<div id="page-wrapper">
				...
				<div class="thumbnail">
					<img src="img/3.png" style="width: 794px; height: 108px;"
						alt="abcd" data-src="">
				</div>
...
<div class="panel panel-green" style="width: 600px; margin-left: 23%">
				<div class="panel-body">
					<form class="navbar-form navbar-left">
                        <button type="submit" class="btn btn-green">Order Summary</button>
                         </form>
						<table class="table table-hover table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td>${paramValues.quantity[0]}</td>
										<td>${paramValues.price[0]}</td>
									</td>
									</tr>
									<tr>
										<td>2</td>
										<td>${paramValues.name[1]}</td>
										<td>${paramValues.quantity[1]}</td>
										<td>${paramValues.price[1]}</td>
									</tr>
									<tr>
										<td></td>
										<td></td>
										...
										<td>Rs ${param.total}</td>
									</tr>
								</tbody>
								</table>
							<form class="navbar-form navbar-left">
                        <button type="submit" class="btn btn-green">Pick Up</button>
                         </form>
							<table class="table table-hover table-bordered">
								<thead>
									<tr>
								...
								<tbody>
									<tr>
										<td>1</td>
										<td>${param.pickupdate}</td>
										<td>${param.pickuptime}</td>
										<td>${param.pickupname}</td>
									</td>
									</tr>
								</tbody>
								</table>
								...
								<form class="navbar-form navbar-left">
                        <button type="submit" class="btn btn-green">Delivery</button>
                         </form>
								<table class="table table-hover table-bordered">
								<thead>
									<tr>
								...
								<tbody>
									<tr>
										<td>1</td>
										<td>${param.deliverydate}</td>
										<td>${param.deliverytime}</td>
										<td>${param.deliveryname}</td>
									
									</tr>
								</tbody>
								</table>
<!-- Book-A-ninja values -->							
<form class="navbar-form navbar-left" method="post" action="Washiz.do?submit=neworder">	
...
<input type="hidden" value="${param.total}" name="price" />	
	<div class="form-actions text-right pal"><button type="submit" class="btn btn-primary">Proceed to Payment</button></div>
								</form>
								</div>
							</div>
						</div>
