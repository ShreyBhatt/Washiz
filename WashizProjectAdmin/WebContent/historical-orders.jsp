            ...
            <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" class="navbar navbar-default navbar-static-top">
             <div class="navbar-header">
                <button type="button" data-toggle="collapse" data-target=".sidebar-collapse" class="navbar-toggle"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
                      <a id="logo" href="index.html" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">Washiz</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
...
<li><a href="logout.jsp"><i class="fa fa-key"></i>Log Out</a></li>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
						...
						<li><a href="Washiz.do?submit=currentorders"><i
								class="fa fa-desktop fa-fw">
									<div class="icon-bg bg-pink"></div>
							</i><span class="menu-title">Current Orders</span></a></li>
						<li><a href="Washiz.do?submit=listofusers"><i
								class="fa fa-send-o fa-fw">
									<div class="icon-bg bg-green"></div>
							</i><span class="menu-title">List Of Users</span></a></li>
						<li class="active"><a href="Washiz.do?submit=orderhistory"><i
								class="fa fa-edit fa-fw">
									<div class="icon-bg bg-violet"></div>
							</i><span class="menu-title">Order History</span></a></li>
						<li><a href="Washiz.do?submit=servicedareas"><i
								class="fa fa-th-list fa-fw">
									<div class="icon-bg bg-blue"></div>
							</i><span class="menu-title">Serviced Areas</span></a></li>
						<li><a href="#"><i class="fa fa-database fa-fw">
									<div class="icon-bg bg-red"></div>
							</i><span class="menu-title">Scheduling Options</span></a></li>
                            ...
                            <div class="panel-body">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>1-9-2015</td>
										<td>Rs.30</td>
                                        <td><span class="label label-sm label-info">Clean</span></td>
                                    </tr>
                                    <tr>
                                        <td>1</td>
                                        <td>1-9-2015</td>
                                        <td>1-9-2015</td>
										<td>Rs.30</td>
                                        <td><span class="label label-sm label-warning">Dry</span></td>
                                    </tr>
                                    <tr>
                                        <td>1</td>
                                        <td>1-9-2015</td>
                                        <td>1-9-2015</td>
										<td>Rs.30</td>
                                        <td><span class="label label-sm label-danger">Wash</span></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
