...
<li><a href="logout.jsp"><i class="fa fa-key"></i>Log Out</a></li>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
					...
					<li><a href="Washiz.do?submit=listofusers"><i class="fa fa-send-o fa-fw">
								<div class="icon-bg bg-green"></div>
						</i><span class="menu-title">List Of Users</span></a></li>
					<li><a href="Washiz.do?submit=orderhistory"><i class="fa fa-edit fa-fw">
								<div class="icon-bg bg-violet"></div>
						</i><span class="menu-title">Order History</span></a></li>
					<li><a href="Washiz.do?submit=servicedareas"><i class="fa fa-th-list fa-fw">
	...
	<%
			...
			request.setAttribute("errmsg", "Please Login To Continue");
